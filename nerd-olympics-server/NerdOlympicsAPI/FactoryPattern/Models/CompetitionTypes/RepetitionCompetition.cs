...
{
    public class RepetitionCompetition : ICompetition
    {
        ...
        public RepetitionCompetition(IFactoryRepository repository, int competitionId, ClassificationType classificationType) 
        {
